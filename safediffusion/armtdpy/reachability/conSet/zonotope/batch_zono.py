...
sys.path.append('../..')
import torch
from safediffusion.armtdpy.reachability.conSet.polynomial_zonotope.batch_poly_zono import batchPolyZonotope 
from safediffusion.armtdpy.reachability.conSet.zonotope.zono import zonotope

from safediffusion.armtdpy.reachability.conSet.zonotope.utils import pickedBatchGenerators
...
class batchZonotope:
    ...
    def to_polyZonotope(self,dim=None,prop='None'):
        ...
        Z = torch.cat((self.center.unsqueeze(-2),
