...
from safediffusion.armtdpy.reachability.conSet import polyZonotope 
from safediffusion.armtdpy.reachability.conSet.zonotope.utils import pickedGenerators
...
class zonotope:
    ...
    def __sub__(self,other):
        '''
        Overloaded '-' operator for substraction or Minkowski differender(rence
        self: <zonotope>
        other: <torch.Tensor> OR <zonotope>
        return <zonotope>        
        '''
