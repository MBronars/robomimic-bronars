...
# POLICY_PATH = os.path.join(robomimic.__path__[0], "../diffusion_policy_trained_models/maze2d/medium_diffpolicy_H32/models/model_epoch_1900.pth") # policy checkpoint
POLICY_PATH = os.path.join(robomimic.__path__[0], "../diffusion_policy_trained_models/maze2d_H128/20240704141057/models/model_epoch_700.pth") # policy checkpoint
...
if __name__ == "__main__":
    ...
    # rand_seeds       = np.linspace(0, 101, 100).astype(int)
    rand_seeds       = [12, 99]
    ...
    for rand_seed in rand_seeds:
        try:
            ...
            save_dir = config.safety.render.save_dir + f"seed_{rand_seed}" + f"/{prefix}"
