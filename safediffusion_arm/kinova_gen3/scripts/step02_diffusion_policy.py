...
CONFIG_PATH = os.path.join(os.path.dirname(__file__),
                           "../exps/diffusion0821/safediffusion_arm.json")
        ...
        # Offline rendering
            ...
            if step_i % video_skip == 0:
                if render_mode == "rgb_array":
                    ...
                    #     only_end_effector = True
                    # )

                    # TODO 1: visualize the nominal plan as the trajectory of center of the gripper as a dot
                    # TODO 2: visualize the backup plan if needed
