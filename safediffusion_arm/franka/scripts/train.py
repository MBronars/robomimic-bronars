...
if __name__ == "__main__":
    ...
    """
    # config_path = os.path.join(robomimic.__path__[0], "exps/safediffusion/bread_pick_ACT.json")
    config_path = os.path.join(robomimic.__path__[0], "exps/safediffusion/ACT_pickplace.json")
    # config_path = os.path.join(robomimic.__path__[0], "exps/safediffusion/bread_pick_BCGMM.json")
